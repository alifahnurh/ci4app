...
<div class="mx-4">
    <div class="col-sm-12 col-md-12">
        ...
        <p class="breadcumb-item muted">Dashboard<b class="breadcumb-active blue">Data Kambing</b></p>
        <div class="card mb-4">
            <div class="card-body">
...
<script>
    function datakambing() {
        //membuat menjadi ajax
        $.ajax({
            url: "<?= site_url('kambing/ambildata'); ?>",
            dataType: "json",
