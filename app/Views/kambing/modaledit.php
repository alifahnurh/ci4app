    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Form Edit Data Kambing</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <?= form_open('kambing/updatedata', ['class' => 'formkambing']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                <input type="hidden" name="no" value="<?= $no ?>">
                <div class="mb-3">
                    <label for="namaKambing" class="form-label">Nama Kambing</label>
                    <input type="text" class="form-control" id="namaKambing" name="nama_kambing" placeholder="Nama Kambing" value="<?= $nama_kambing ?>">
                    <div class="invalid-feedback errorNama"></div>
                </div>
                <div class="mb-3">
                    <label for="jenisKelamin" class="form-label">Jenis Kelamin</label>
                    <select class="form-select" id="jenisKelamin" name="jns_kelamin">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="tanggalLahir" name="tgl_lahir" placeholder="Tanggal Lahir" value="<?= $tgl_lahir ?>">
                    <div class="invalid-feedback errorTgl"></div>
                </div>
                <div class="mb-3">
                    <label for="panjang" class="form-label">Panjang</label>
                    <input type="text" class="form-control" id="panjang" name="panjang" placeholder="Panjang" value="<?= $panjang ?>">
                    <div class="invalid-feedback errorPanjang"></div>
                </div>
                <div class="mb-3">
                    <label for="tinggi" class="form-label">Tinggi</label>
                    <input type="text" class="form-control" id="tinggi" name="tinggi" placeholder="Tinggi" value="<?= $tinggi ?>">
                    <div class="invalid-feedback errorTinggi"></div>
                </div>
                <div class="mb-3">
                    <label for="berat" class="form-label">Berat</label>
                    <input type="text" class="form-control" id="berat" name="berat" placeholder="Berat" value="<?= $berat ?>">
                    <div class="invalid-feedback errorBerat"></div>
                </div>
                <div class="mb-3">
                    <label for="lingkarDada" class="form-label">Lingkar Dada</label>
                    <input type="text" class="form-control" id="lingkarDada" name="lingkar_dada" placeholder="Lingkar Dada" value="<?= $lingkar_dada ?>">
