    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Form Edit Hasil Pemerahan</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <?= form_open('pemerahan/updatedata', ['class' => 'formperah']) ?>
            <?= csrf_field(); ?>
            <div class="modal-body">
                <input type="hidden" name="no" value="<?= $no ?>">
                <div class="mb-3">
                    <label for="namaKambing" class="form-label">Nama Kambing</label>
                    <input type="text" class="form-control" name="nama_kambing" id="namaKambing" placeholder="Nama Kambing" autofocus value="<?= $nama_kambing ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="hasilPemerahan" name="hsl_pemerahan" placeholder="Hasil Pemerahan" autofocus value="<?= $hsl_pemerahan ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" id="tglPemerahan" name="tgl_pemerahan" autofocus value="<?= $tgl_pemerahan ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="time" class="form-control" id="wktPemerahan" name="wkt_pemerahan" autofocus value="<?= $wkt_pemerahan ?>">
